 ...
 Sample Code:
     ...
     ********************** json convertor *********************
     ...
     int main() {
         ...
         YYBook *book = [YYBook cw_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book cw_modelToJSONString];
     ...
     ********************** Coding/Copying/hash/equal *********************
     ...
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self cw_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self cw_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self cw_modelCopy]; }
     - (NSUInteger)hash { return [self cw_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self cw_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (CWModel)
 ...
 */
+ (nullable instancetype)cw_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)cw_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)cw_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)cw_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)cw_modelToJSONObject;
 ...
 */
- (nullable NSData *)cw_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)cw_modelToJSONString;
 ...
 */
- (void)cw_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)cw_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)cw_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (CWModel)
 ...
 */
+ (nullable NSDictionary *)cw_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
