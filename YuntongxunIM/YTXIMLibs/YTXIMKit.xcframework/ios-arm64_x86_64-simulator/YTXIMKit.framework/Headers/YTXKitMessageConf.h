...
//  YTXIMKit
//
//  Created by dongxuelei on 2020/6/23.
//  Copyright © 2020 yuntongxun. All rights reserved.
//

#import <UIKit/UIKit.h>

@interface YTXKitMessageConf : NSObject
#pragma mark - Config
...
/*!
 ...
 Swift 需获取到 rawValue 传入（例如 [ YTXConversationType.ConversationType_PRIVATE.rawValue ]）。
 */
...
/*!
 ...
 未注册的消息，可以通过YTXConversationViewController中的rcUnkownConversationCollectionView:cellForItemAtIndexPath:和rcUnkownConversationCollectionView:layout:sizeForItemAtIndexPath:方法定制在会话页面的显示。
