...
//  iOS-IMKit
//
//  Created by dongxuelei on 14/10/29.
 ...
 *  RCAttributedLabel
 */
@interface YTXAttributedLabel : UILabel <RCAttributedDataSource, UIGestureRecognizerDelegate>
/**
 ...
 *  -(void)willDisplayConversationTableCell:(YTXMessageBasedCell *)cell atIndexPath:(NSIndexPath *)indexPath{
 *
 *   if ([cell isKindOfClass:[YTXTextMessageCell class]]) {
 *      YTXTextMessageCell *newCell = (YTXTextMessageCell *)cell;
...
/*!
 ...
 @param url   点击的URL
 */
- (void)attributedLabel:(YTXAttributedLabel *)label didSelectLinkWithURL:(NSURL *)url;
 ...
 */
- (void)attributedLabel:(YTXAttributedLabel *)label didSelectLinkWithPhoneNumber:(NSString *)phoneNumber;
...
/*!
 ...
 @param content 点击的内容
 */
- (void)attributedLabel:(YTXAttributedLabel *)label didTapLabel:(NSString *)content;
