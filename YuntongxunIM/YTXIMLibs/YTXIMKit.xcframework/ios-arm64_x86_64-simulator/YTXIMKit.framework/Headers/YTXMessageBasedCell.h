 ...
 */
+ (CGSize)sizeForMessageModel:(YTXMessageModel *)model
...
/*!
 消息Cell点击回调
 */
@property (nonatomic, weak) id<YTXMessageCellDelegate> delegate;

/*!
 显示时间的Label
 */
@property (strong, nonatomic) YTXTipLabel *messageTimeLabel;

/*!
 消息Cell的数据模型
 */
@property (strong, nonatomic) YTXMessageModel *model;
...
/*!
 消息的方向
 */
@property (nonatomic) YTXMessageDirection messageDirection;
