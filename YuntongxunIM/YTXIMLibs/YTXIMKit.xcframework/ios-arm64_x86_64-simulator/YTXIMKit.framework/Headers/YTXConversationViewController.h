...
@interface YTXConversationViewController
    : YTXBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout,
...
/*!
 ...
 @return 会话页面对象
 */
- (id)initWithConversationType:(YTXConversationType)conversationType targetId:(NSString *)targetId;
...
/*!
 当前会话的会话类型
 */
@property (nonatomic) YTXConversationType conversationType;

@property (nonatomic,strong) YTXConversationModel *conversationModel;
...
/*!
 ...
 @discussion 数据源中存放的元素为消息Cell的数据模型，即YTXMessageModel对象。
...
/*!
 ...
 (需要将YTXConversationType转为NSNumber构建Array)
 */
 ...
 */
@property (nonatomic, strong, readonly) NSArray<YTXMessageModel *> *selectedMessages;
 ...
 */
//- (void)sendMessage:(YTXMessageContent *)messageContent pushContent:(NSString *)pushContent;

- (void)sendFileMessage:(YTXMessage *)messageContent;
 ...
 */
//- (void)sendMediaMessage:(YTXMessageContent *)messageContent
 ...
 */
//- (void)uploadMedia:(YTXMessage *)message uploadListener:(RCUploadMediaStatusListener *)uploadListener;
 ...
 */
- (void)cancelUploadMedia:(YTXMessageModel *)model;
/*!
 重新发送消息
 ...
 */
//- (void)resendMessage:(YTXMessageContent *)messageContent;
 ...
 */
- (void)appendAndDisplayMessage:(YTXMessage *)message;
 ...
 */
- (void)deleteMessage:(YTXMessageModel *)model;
 ...
 */
//- (YTXMessageContent *)willSendMessage:(YTXMessageContent *)messageContent;
...
/*!
 ...
 @param messageContent   消息内容
 */
//- (void)didSendMessage:(NSInteger)status content:(YTXMessageContent *)messageContent;
...
/*!
 ...
 @param messageContent   消息内容
 */
//- (void)didCancelMessage:(YTXMessageContent *)messageContent;
 ...
 */
- (YTXMessage *)willAppendAndDisplayMessage:(YTXMessage *)message;
 ...
 */
- (void)willDisplayMessageCell:(YTXMessageBasedCell *)cell atIndexPath:(NSIndexPath *)indexPath;
...
*/
- (BOOL)willSelectMessage:(YTXMessageModel *)model;
...
*/
- (BOOL)willCancelSelectMessage:(YTXMessageModel *)model;
...
/*!
 ...
 @param messageClass  自定义消息Cell对应的自定义消息的类，该自定义消息需要继承于YTXMessageContent

 @discussion
 你需要在cell中重写YTXMessageBasedCell基类的sizeForMessageModel:withCollectionViewWidth:referenceExtraHeight:来计算cell的高度。
 */
...
/*!
 ...
 如提示当前版本不支持，引导用户升级等。
 */
- (YTXMessageBasedCell *)rcUnkownConversationCollectionView:(UICollectionView *)collectionView
...
/*!
 ...
 您在重写此回调时，如果想保留SDK原有的功能，需要注意调用super。
 */
- (NSArray<UIMenuItem *> *)getLongTouchMessageCellMenuList:(YTXMessageModel *)model;
 ...
 */
- (void)presentImagePreviewController:(YTXMessageModel *)model;
 ...
 */
- (void)presentFilePreviewViewController:(YTXMessageModel *)model;
 ...
 */
- (void)showChooseUserViewController:(void (^)(YTXUserInfo *selectedUserInfo))selectedBlock
