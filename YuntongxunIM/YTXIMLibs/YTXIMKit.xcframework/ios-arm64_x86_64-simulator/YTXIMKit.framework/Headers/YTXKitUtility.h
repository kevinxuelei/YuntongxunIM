...
/*!
 IMKit工具类
 */
@interface YTXKitUtility : NSObject
...
/*!
 ...
 conversationDigest 获取消息摘要。
*/
//+ (NSString *)formatLocalNotification:(YTXMessage *)message;
...
/*!
 ...
 自定义消息会调用YTXMessageContent中YTXMessageContentView协议的conversationDigest获取消息摘要。
...
/*!
 ...
 @return 是否需要显示
 */
//+ (BOOL)isVisibleMessage:(YTXMessage *)message;
...
/*!
 ...
 @return 是否需要显示
 */
//+ (BOOL)isUnkownMessage:(long)messageId content:(YTXMessageContent *)content;
 ...
 */
//+ (NSDictionary *)getNotificationUserInfoDictionary:(YTXMessage *)message;
...
/*!
 ...
 @return                    本地通知的Dictionary
 */
//+ (NSDictionary *)getNotificationUserInfoDictionary:(YTXConversationType)conversationType
...
/*!
 ...
 @return 默认的占位头像
 */
//+ (UIImage *)defaultConversationHeaderImage:(YTXConversationModel *)model;
...
/*!
 ...
 @return 显示的标题
 */
//+ (NSString *)defaultTitleForCollectionConversation:(YTXConversationType)conversationType;
...
/*!
 ...
 @return 未读消息数
 */
//+ (int)getConversationUnreadCount:(YTXConversationModel *)model;
...
/*!
 ...
 @return 是否包含未读的@消息
 */
//+ (BOOL)getConversationUnreadMentionedStatus:(YTXConversationModel *)model;
 ...
 */
//+ (void)syncConversationReadStatusIfEnabled:(YTXConversation *)conversation;
