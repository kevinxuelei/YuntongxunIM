...
/*!
 角标的位置
 */
typedef NS_ENUM(NSInteger, YTXMessageBubbleTipViewAlignment) {
    /*!
     左上
     */
...
/*!
 消息未读提示角标的View
 */
@interface YTXMessageBubbleTipView : UIView
 ...
 */
@property (nonatomic, assign) YTXMessageBubbleTipViewAlignment bubbleTipAlignment;
...
/*!
 ...
 @return            角标View对象
 */
- (instancetype)initWithParentView:(UIView *)parentView alignment:(YTXMessageBubbleTipViewAlignment)alignment;
